...
ax.plot(epoch_list, loss_list, linewidth=6, color='blue')
ax.set_xlabel("Number of Epochs")
ax.set_ylabel("Loss")
ax.set_title('Training Loss for Sorting Recipes')
plt.savefig('training_loss_for_recipe_sorting.png',dpi=300, bbox_inches='tight')
